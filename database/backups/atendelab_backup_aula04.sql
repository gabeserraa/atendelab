...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25/06/2026 às 00:58
...
(2, 1, 1, 1, '2025-08-18', '19:00:00', 'Primeiro atendimento', 'API', 'aberto', '2026-06-17 17:16:29');
...
(1, 'Gabriel att', '123456789', '47997901762', 'ADS', 'Noturno', 'ativo');
...
(1, 'Suporte Acadêmico', 'Atendimento relacionado ao suporte acadêmico', 'ativo'),
(2, 'Suporte Academico', 'Atendimento', 'ativo');
...
(1, 'Administrador', 'admin@atendelab.com', '$2y$10$XVgqKRAolby0MydjvbNf7OQQIGsIh7TZx4fdV9ks0iUObmOwQvL.C', 'admin', 'ativo', '2026-06-15 16:35:24');
